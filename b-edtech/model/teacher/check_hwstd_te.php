        ...
        <table class="table table-sm">
            ...
            if(isset($resault_std_table_list)){
                ...
                <tr>
                    ...
                    ?></td>
                    <td class="text-center"><?php if($return_status[0]=="success") echo $return_status[2];
                            else echo "-";
                    ?></td>
                    <form method="post">
                    <td>
                        ...
                        <input type="hidden" name="std_id" value="<?php echo $list_std['std_id']; ?>" >
                        <input name="scoregrading" type="text" class="form-control" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon2" 
                            <?php
                                if($return_status[0]=="unsuccess") echo "disabled";
                                elseif($return_status[0]=="success" && isset($return_status[1])) {
                                    ?>
                                    value="<?php echo $return_status[1];?>"
                                    <?php
                                    echo "disabled";
                                }
                            ?>
                            >
                        <button name="confirm_grading" class="btn btn-primary" type="submit" id="button-addon2" 
                            <?php
                                if($return_status[0]=="unsuccess") echo "disabled";
                                elseif($return_status[0]=="success" && isset($return_status[1])) {
                                    echo "disabled";
