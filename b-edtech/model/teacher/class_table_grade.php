            ...
            <table class="table table-sm">
                ...
                if(isset($resault_table)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../../view/teacher/index_logged-tech_std_list_grade.php?classroom_id=<?php echo $list_class['classroom_id'] ?>&classroom_name=<?php echo $list_class['classroom_name'] ?>" class="btn btn-success col-md-12">ดูคะแนนรวม</a>
                        </td>
                    </tr>
                    <?php
                    $i++;
