                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <select class="form-select" name="select_class_id" id="select_class_id" disabled>
                            ...
                            <?php print_option_classroom($conn,$hw_data['classroom_id'],$hw_data['subject_id']) ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <select class="form-select" name="select_subj_id" id="select_subj_id" disabled>
                            <option value="<?php echo $hw_data['subject_id']; ?>">
                                <?php echo $hw_data['subject_name']; ?></option>
                            <?php print_option_subject($conn, $hw_id,$hw_data['subject_id']) ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        <label for="hw_level">ระดับการเรียนรู้</label>
                            <select class="form-control" id="hw_level" name='hw_level' disabled>
                                <option selected  value="<?php echo $hw_data['level']; ?>" readonly ><?php echo option_bloom_list($hw_data['level']); ?></option>
...
<?php
function print_option_classroom($conn,$hw_c_id,$subj_id)
{
    $sql = "SELECT * FROM `classroom_subj_list` class_subj
            LEFT JOIN `classroom` class ON class.classroom_id=class_subj.classroom_id
...
{
    $sql = "SELECT subj.subject_id,subj.subject_codename,subj.subject_name,subj.teacher_id 
                FROM `subject`subj
...
function option_bloom_list($value)
{
    $bloom_option=[1=>'การจำ',2=>'การเข้าใจ',3=>'การประยุกต์ใช้',4=>'การวิเคราะห์',5=>'การประเมินผล',6=>'การสร้างสรรค์'];
    if(isset($value)){
        return $bloom_option[$value];
    }
}
?>
...
function editfunc() {
    ...
    document.getElementById('hw_level').removeAttribute('disabled');
