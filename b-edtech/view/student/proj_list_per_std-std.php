                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="row p-1">
                            <h4 >การทำงาน</h4>
                                ...
                                <div class="row">
                                    <h4 class="my-3 d-flex justify-content-xl-start justify-content-center">
                                        วิชาที่สั่งโปรเจค
                                    </h4>
                                    <div class="row mx-2">
                                        ...
                                        if (mysqli_num_rows($result) >= 1) {
                                            ...
                                            ?>
                                                <div class="col-12 col-lg-3 col-md-6 col-sm-12 px-3 ">
                                                    <a href="<?php echo $view.$role_route."hwproject_detail_stu.php"."?proj_id=".$card_subj_proj['proj_id']; ?>">
