                                    ...
                                    <div class="row text-center text-lg-start">
                                        ...
                                        <div class="col-6 col-lg-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <p>&nbsp;&nbsp;&nbsp;<?php echo $std_detail['classroom_name'];?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--<div class="col-6 col-lg-3">
                            ...
                            <h4 >การทำงาน</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mx-2">
                                        ...
                                        <?php
                                        $result = card_subj_hw($conn, $class_id);
                                        if (mysqli_num_rows($result) >= 1) {
                                        while ($card_subj_hw = mysqli_fetch_array($result)) {
                                        //print_r($detailstd);
                                        ?>
                                            <div class="col-12 col-lg-3 col-md-6 col-sm-12 px-3 ">
                                                <a href="<?php echo $view.$role_route."index_send_hw_std.php"."?subj_id=".$card_subj_hw['subject_id']; ?>">
                                                            ...
                                                            <div class="d-flex justify-content-center ">
                                                                ...
                                                                <div class="col-md-8 mx-2">
                                                                    ...
                                                                    <h6 class="text-muted font-semibold">
                                                                        <?php echo $card_subj_hw['subject_name'] ?>
                                                                    </h6>
                                                                    <h6 class="font-extrabold mb-0">
                                                                        จำนวนงาน: <?php echo $card_subj_hw['sum_hw'] ?>
                                                                    </h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        ?>
                                    <div class=" card py-5 align-content-center justify-content-center">
