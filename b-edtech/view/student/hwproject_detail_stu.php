                                    ...
                                    <div class="card py-2">
                                        ...
                                        <div class="row ">
                                                                            ...
                                                                            <tr class="">
                                                                                <td class="col-md-2 ">
                                                                                    <?php
                                                                                                    ...
                                                                                                    ?>
                                                                                    <div class="alert alert-danger">ไม่มีกลุ่ม</div>
                                                                                    <?php
                                                                                                    }
                                                                                ...
                                                                                <td class="col-md-3 ">
                                                                                    <?php
                                                                                                    ...
                                                                                                    ?>
                                                                                    <form method="POST"
                                                                                        action="../../model/student/send_db_hwproj_std.php "
                                                                                        enctype="multipart/form-data">
                                                                                        <input name="group_id" type="hidden"
                                                                                            value="<?php echo $array_group_detail['group_id'] ?>">
                                                                                        <input class="form-control" type="hidden" name="worklist_id"
                                                                                            value="<?php echo $table_li_p1_wl['worklist_id']; ?>">
                                                                                        <input class="form-control" type="hidden"
                                                                                            name="stu_username"
                                                                                            value="<?php echo $stu_username; ?>">
                                                                                        <input class="form-control" type="file" name="files"
                                                                                            id="file"><br>
                                                                                        <input class="form-control" type="submit" name="button"
                                                                                ...
                                                                                <td class="col-md-3 ">
                                                                                    ...
                                                                                    <form method="POST"
                                                                                        ...
                                                                                        <input name="group_id" type="hidden"
                                                                                            value="<?php echo $array_group_detail['group_id'] ?>">
                                                                                        <input class="form-control" type="hidden" name="worklist_id"
                                                                                            value="<?php echo $table_li_p2_wl['worklist_id']; ?>">
                                                                                        <input class="form-control" type="hidden"
                                                                                            name="stu_username"
                                                                                            value="<?php echo $stu_username; ?>">
                                                                                        <input class="form-control" type="file" name="files"
                                                                                    ...
                                                                                    <td class="col-md-3 ">
                                                                                        ...
                                                                                        <form method="POST"
                                                                                            ...
                                                                                            <input name="group_id" type="hidden"
                                                                                                value="<?php echo $array_group_detail['group_id'] ?>">
                                                                                            <input class="form-control" type="hidden" name="worklist_id"
                                                                                                value="<?php echo $table_li_p3_wl['worklist_id']; ?>">
                                                                                            <input class="form-control" type="hidden"
                                                                                                name="stu_username"
                                                                                                value="<?php echo $stu_username; ?>">
                                                                                            <input class="form-control" type="file" name="files"
                                            ...
                                            <div class="col-12 d-flex justify-content-end">
                                                <a type="submit" 
                                                    class="btn btn-light-primary me-1 mb-1 btn-lg 
                                                    <?php if($group_id!="none") echo "d-none"; ?>"
                                                    href="create_projgroup_stu.php?proj_id=<?php echo $proj_id; ?>">จับกลุ่ม</a>
                                                <a type="submit" class="btn btn-success me-1 mb-1 btn-lg" value="add_proj"
                                                    href=" http://meet.google.com/new " target="_blank">Meet!</a>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
