...
$subject_codename=$_GET['subj_codename'];
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="text-center">ห้องเรียน: <?php echo $classroom_name ?> | ภาคเรียน:
                                            <?php echo $table_subj_detail['semester']?></h4>
                                    ...
                                    <div class="card-body">
                                        <?php 
                                            require "../../model/teacher/all_table_grading_te.php"; 
                                        ?>
                                    </div>
                                </div>
                            </div>
